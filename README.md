...
| jq                  | `jq` es una herramienta de línea de comandos para procesar y manipular datos en formato JSON. Permite consultar, filtrar y transformar datos JSON de manera efectiva. | [Repositorio de jq en GitHub](https://github.com/stedolan/jq) <br> [Sitio web de jq](https://jqlang.github.io/jq/) |
