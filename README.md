...
| Ag (Silver Searcher)| Ag, o Silver Searcher, es una herramienta de búsqueda rápida de texto que se utiliza para buscar patrones en directorios y archivos. Es especialmente eficiente en búsquedas grandes. | [Repositorio de Ag en GitHub](https://github.com/ggreer/the_silver_searcher) |
